...
Mi piace capire come funzionano le cose, sperimentare e migliorare
continuamente le mie competenze tecniche.

Il mio percorso è iniziato con Arduino, dove mi sono avvicinato
all’elettronica e alla programmazione di microcontrollori.
Successivamente mi sono spostato sullo sviluppo web, partendo da
HTML e CSS fino ad arrivare allo sviluppo back-end con PHP,
MySQL e phpMyAdmin.

Negli ultimi tempi mi sto dedicando anche allo sviluppo mobile
per Android utilizzando Android Studio e Kotlin, con l’obiettivo
di creare applicazioni complete e funzionali.

Mi interessa sia il front-end che il back-end e mi piace lavorare
su progetti che uniscono logica, interfaccia e funzionalità reali.

Competenze principali:
- Sviluppo web front-end (HTML, CSS, JavaScript, Bootstrap)
- Sviluppo web back-end (PHP, MySQL, Laravel)
- Sviluppo mobile Android (Kotlin, Android Studio)
- Elettronica e prototipazione con Arduino
- Utilizzo di Linux e strumenti di sviluppo
...
Continuare a crescere come sviluppatore, imparare nuove tecnologie
e trasformare la mia passione per la programmazione e l’elettronica
in qualcosa di concreto, utile e reale.
